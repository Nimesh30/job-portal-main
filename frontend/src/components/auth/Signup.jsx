    ...
    <div>
      ...
      <div className=" md:max-w-7xl  mx-auto flex items-center justify-center ">
        <form
          ...
          className="md:w-1/2  max-md:m-5 max-md:mt-15  border border-gray-300 rounded-md p-5 my-10"
        >
            ...
            <div className="flex max-md:grid max-md:grid-cols-2">
              <div className="my-2 mr-5">
                <div className="flex max-md:gap-2  max-md:justify-center ">
                  ...
                  />
                  <Label htmlFor="student" className="md:ml-2 cursor-pointer">
                    Student
                  </Label>
                </div>
              </div>
              ...
              <div className=" my-2 ">
                <div className="flex max-md:gap-2 max-md:justify-center">
                  <input
                    ...
                    className=" cursor-pointer "
                  />
                  <Label htmlFor="reqruiter" className="md:ml-2 cursor-pointer">
                    Recruiter
                  </Label>
                </div>
              </div>
          ...
          {loading ? (
            ...
            <Button
              ...
              disabled={input?.file?.name == undefined}
            >
              Sign up
            </Button>
          )}
